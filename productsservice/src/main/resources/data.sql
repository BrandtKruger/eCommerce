insert into productdb.productinfo (name,category,description, price, product_condition, product_status, units_in_stock, manufacturer) values ('iPhone11', 'Phones', 'iPhone 11', 1500000, 'NEW', 'IN_STOCK', 10, 'Apple');
